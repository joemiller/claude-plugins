---
name: reviewer
description: Adversarial code reviewer. Finds material issues and returns them in a structured schema. Dispatched by the review orchestrator, not invoked directly.
model: sonnet
